    ...
    while True: 
        ...
        try:
            ...
            if user_answer2.lower() == 'yes':
                ...
                print('Your midle name is:', user_input_line2)
             # If the user answers 'no', it prints 'Go to next line'
            elif user_answer2.lower() == 'no':
                print('Go to next line')
                # If a SpecialCharacterError is raised, it prints the error message
        except SpecialCharacterError as e:
        ...
        # If a SpecialCharacterError is raised, it prints the error message and continues with the next iteration of the loop    
        except SpecialCharacterError as e:
            print(e, 'You have entered an invalid record')
            continue
